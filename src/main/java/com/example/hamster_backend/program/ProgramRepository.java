package com.example.hamster_backend.program;
...
public interface ProgramRepository extends JpaRepository<Program, Long> {
    ...
    @Query("select new com.example.hamster_backend.program.Program(p.programId, p.programName, p.programPath) from Program p where p.userId = :user_id")

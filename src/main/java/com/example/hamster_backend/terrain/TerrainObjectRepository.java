...
public interface TerrainObjectRepository extends JpaRepository<TerrainObject, Long> {
    ...
    @Query("select new com.example.hamster_backend.terrain.TerrainObject(t.terrainId, t.terrainName, t.terrainPath) from TerrainObject t where t.userId = :user_id")

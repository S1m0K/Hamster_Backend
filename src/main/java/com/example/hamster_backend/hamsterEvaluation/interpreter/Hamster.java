package com.example.hamster_backend.hamsterEvaluation.interpreter;
...
public class Hamster {
	...
	public void init(int reihe, int spalte, int blickrichtung, int anzahlKoerner)
		...
		} catch (com.example.hamster_backend.hamsterEvaluation.model.HamsterNichtInitialisiertException exc) {
	...
	public void vor() throws HamsterNichtInitialisiertException, MauerDaException {
		...
		} catch (com.example.hamster_backend.hamsterEvaluation.model.MauerDaException exc) {
	...
	public void gib() throws HamsterNichtInitialisiertException, MaulLeerException {
		try {
			...
			throw new HamsterNichtInitialisiertException(this);
		} catch (com.example.hamster_backend.hamsterEvaluation.model.MaulLeerException exc) {
	...
	public void nimm() throws HamsterNichtInitialisiertException, KachelLeerException {
		try {
			...
			throw new HamsterNichtInitialisiertException(this);
		} catch (com.example.hamster_backend.hamsterEvaluation.model.KachelLeerException exc) {
	...
	public int getReihe() throws HamsterNichtInitialisiertException {
		try {
			checkInit("getReihe()");
			com.example.hamster_backend.hamsterEvaluation.simulation.model.Hamster h = Workbench.getWorkbench().getSimulationController()
	...
	// } else {
	// hamsterEvaluation.simulation.com.example.hamster_backend.model.Hamster hThis = _intern_simulationModel
	// .getHamster(this._intern_id);
	// hamsterEvaluation.simulation.com.example.hamster_backend.model.Hamster hOther = _intern_simulationModel
	...
	public String toString() {
		...
		if (!this._intern_init) {
			...
			int a = 0;
			String b = "";
			com.example.hamster_backend.hamsterEvaluation.simulation.model.Hamster hThis = Workbench.getWorkbench().getSimulationController()
					.getSimulationModel().getHamster(this._intern_id);
			switch (hThis.getDir()) {
			case NORD:
				b = "NORD";

...
public class Precompiler {
    ...
    public boolean precompile(HamsterFile file) throws IOException {
        ...
        if (t != null) {
            ...
            /* dibo 20.05.05 */
            out
                    .print("import at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterException;");
            out
                    .print("import at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterInitialisierungsException;");
            out
                    .print("import at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterNichtInitialisiertException;");
            ...
            /* lego */
            if (type != HamsterFile.IMPERATIVE
            ...
            if (type == HamsterFile.OBJECT) {
                out.print("public class " + className.substring(0, className.length() - 5)
                        + " implements at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterProgram {");
                System.out.println("Object");
            } else if (type == HamsterFile.IMPERATIVE)
                out.print("public class " + className
                        + " extends at.ac.htlinn.hamsterbackend.hamsterEvaluation.debugger.model.IHamster"
                        + " implements at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterProgram {");
                /* Lego-Christian */
            else if (type == HamsterFile.LEGOPROGRAM) {
                out
                        .print("import at.ac.htlinn.hamsterbackend.hamsterEvaluation.lego.model.MaulNichtLeerException;");
                out.print("import at.ac.htlinn.hamsterbackend.hamsterEvaluation.lego.model.KornDaException;");
                out.print("public class " + className
                        + " extends at.ac.htlinn.hamsterbackend.hamsterEvaluation.lego.model.LHamster"
                        + " implements at.ac.htlinn.hamsterbackend.hamsterEvaluation.model.HamsterProgram {");
            }
        }
